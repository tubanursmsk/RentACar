...
@Component({
  ...
  template: `
    <div>
      <!-- Başlık -->
      <div class="mb-6">
        <h2 class="text-2xl font-bold text-avis-600 mb-2">Güvence Paketleri</h2>
      ...
      @if (loading()) {
            ...
            <div class="card relative flex flex-col transition-all duration-200"
              ...
              <div class="p-5">
                ...
                <div class="flex items-baseline justify-between mb-1">
                  <h3 class="text-lg font-bold text-avis-600">{{ pkg.name }}</h3>
                </div>
              ...
              <div class="p-5 pt-3 border-t border-ink-100 flex items-center justify-between">
                ...
                <button (click)="selectPackage(pkg)"
                        ...
                        [class.bg-avis-600]="!isSelected(pkg.id)"
        ...
        <div class="mt-6 text-center">
          <button (click)="skipInsurance()"
                  class="text-sm text-ink-500 hover:text-avis-600 underline">
